    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zh_hans_content', models.CharField(max_length=200, verbose_name='Content in Chinese Simplified')),
                ('zh_hant_content', models.CharField(max_length=200, verbose_name='Content in Chinese Traditional')),
